class NationalInterest {
    constructor(element) {
        ...
        this.reason = element.hasOwnProperty('motivering') ? element.motivering : "<i>Inget information finns tillgänglig</i>";
        this.expression = element.hasOwnProperty('Uttryck_för_RI') ? element.Uttryck_för_RI : "<i>Inget information finns tillgänglig</i>";
        ...
        this.firstRevision  = element.hasOwnProperty('Tidigare revidering RAÄ') ? element["Tidigare revidering RAÄ"] : "<i>Inget information finns tillgänglig</i>";
